...
namespace Inworld.NDK
{
    public static class InworldPacketConverter
    {
        ...
        //         return toSend;
        //     }
        public static MutationPacket CancelResponseEvent(string charID, string interactionID)
        {
            MutationPacket toSend = new MutationPacket();
            toSend = new MutationPacket();
        ...
        public static CustomPacket CustomEvent(string charID, string triggerName, Dictionary<string, string> parameters)
        {
            CustomPacket toSend = new CustomPacket();
            ...
            {
                toSend.custom.parameters.Add(new TriggerParamer()
                {
                    name = kvp.Key,
                    value = kvp.Value
                });
        ...
        //         return toSend;
        //     }
        public static AudioPacket AudioChunk(string charID, string base64)
        {
            AudioPacket toSend = new AudioPacket();
            toSend.dataChunk.chunk = ByteString.FromBase64(base64).ToString();
